...
// use reduce() to count the number of total contributions by summing the backer

const totalContrib = GAMES_JSON.reduce( (sum ,game) => {
...
const unfundCount = listOfUnfunded.length;

// create a string that explains the number of unfunded games using the ternary operator
let displayStr = `A total of $${totalRaised.toLocaleString('en-US')} has been raised for 11 games. Currently, ${unfundCount} ${unfundCount>1 ? "games remain" : "game remains"} unfunded. We need tyour help to fund these amazing games!`;
